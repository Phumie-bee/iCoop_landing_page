...
const testimonials = [
  {
    ...
    name: "Adebayo Yusuf",
    role: "Treasurer, Lagos Teachers\u2019 Cooperative",
    avatar: "AY",
  },
  {
    quote:
      "Our members kept asking for their loan balances. Now they just check their portal. Support calls dropped by 60% in the first month.",
    name: "Fatima Bello",
    role: "Manager, Unity Staff Cooperative",
    avatar: "FB",
  },
  {
    quote:
      "We tried three other platforms. None of them understood patronage dividends, thrift contributions, or how Nigerian cooperatives actually operate.",
    name: "Chioma Okafor",
...
const stats = [
  { value: "\u20A650B+", label: "Transactions tracked" },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <FadeIn className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-base leading-relaxed text-muted-foreground">
            Hear from the treasurers, managers, and board members who made the move.
          </p>
        </FadeIn>
        ...
        <StaggerContainer className="mt-12 grid gap-5 md:grid-cols-3" staggerDelay={0.1}>
          {testimonials.map((t) => (
